    ...
    return(
        ...
        <Modal.Body>
          <Form onSubmit={sendUpdate}>
            <Form.Group 
            className="mb-3" 
            controlId="tile_input.item_name">
            ...
            <Form.Group
              className="mb-3"
              controlId="tile_input.description"
            >
              ...
              rows={2}
              ref={descriptionRef} />
              <Form.Text className="text-muted">This is a good place to let people know if there are specific rules or exclusions for this tile. Description will be viewable on tile hover-over.</Form.Text>
            </Form.Group>
